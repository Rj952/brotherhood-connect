  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-6 animate-fade-in"
      ...
      <div className="w-full max-w-xl p-10 card-base border-gold/10 rounded-3xl text-center animate-fade-up"
        ...
        <div className="text-6xl mb-3">ð¤</div>
        ...
        <div className="text-left p-5 rounded-xl bg-gold/10 border border-gold/10 mb-5">
          <div className="py-1 text-sm">ð¡ï¸ <strong>Privacy</strong> â What happens in the circle stays in the circle</div>
          <div className="py-1 text-sm">ðª <strong>Strength</strong> â Vulnerability is a sign of courage, not weakness</div>
          <div className="py-1 text-sm">ð <strong>Culture</strong> â Our heritage and traditions are sources of power</div>
          <div className="py-1 text-sm">ð¤ <strong>Brotherhood</strong> â We rise by lifting each other</div>
          <div className="py-1 text-sm">ð <strong>Evidence</strong> â Every strategy here is backed by research</div>
        </div>
