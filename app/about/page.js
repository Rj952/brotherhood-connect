      ...
      <div className="max-w-3xl mx-auto px-6 pt-16 pb-20 relative z-10">
        <div className="card-base border-gold/10 rounded-3xl p-10 md:p-12">
          ...
          <div className="mt-8 pt-6 border-t border-white/[0.06] text-sm text-gray-500">
            ...
            <p className="mt-2">
              Senior Instructional Designer, University of Central Florida • Inclusive Educator, UCCI •
              AI Consultant, UTech Jamaica • Honorary Advisor, Farquharson Institute of Public Affairs •
              Fellow, AAC&U Faculty AI Institute • Fellow, UK Higher Education Academy
            </p>
